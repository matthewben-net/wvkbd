...
static struct key keys_landscape[] = {
  ...
  {"Del", "Del", 0.85, Code, KEY_DELETE, .scheme = 1},
  {"", "", 0.05, Pad},
  {"", "", 0.0, EndRow},

  {"", "", 0.05, Pad},
  {"`", "~", 0.81, Code, KEY_GRAVE, .scheme = 1},
  {"1", "!", 1.0, Code, KEY_1},
  {"2", "@", 1.0, Code, KEY_2},
  {"3", "#", 1.0, Code, KEY_3},
  {"4", "$", 1.0, Code, KEY_4},
  ...
  {"9", "(", 1.0, Code, KEY_9, &layouts[ComposeBracket]},
  {"0", ")", 1.0, Code, KEY_0, &layouts[ComposeBracket]},
  {"-", "_", 0.6, Code, KEY_MINUS, &layouts[ComposeBracket]},
  {"=", "+", 0.6, Code, KEY_EQUAL, &layouts[ComposeBracket]},
  {"⌫", "⌫", 1.0, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.05, Pad},
  {"", "", 0.0, EndRow},
  ...
  {"\\", "|", 0.5, Code, KEY_BACKSLASH, .scheme = 1},
  {"", "", 0.05, Pad},
  {"", "", 0.0, EndRow},

  {"", "", 0.05, Pad, .scheme = 1},
  {"󰘲", "󰘲", 1.15, Mod, CapsLock, .scheme = 1},
  {"a", "A", 1.0, Code, KEY_A, &layouts[ComposeA]},
  {"s", "S", 1.0, Code, KEY_S, &layouts[ComposeS]},
  {"d", "D", 1.0, Code, KEY_D, &layouts[ComposeD]},
  {"f", "F", 1.0, Code, KEY_F, &layouts[ComposeF]},
  ...
  {"󰌑", "󰌑", 1.15, Code, KEY_ENTER, .scheme = 2},
  {"", "", 0.05, Pad},
  {"", "", 0.0, EndRow},

  {"", "", 0.05, Pad},
  {"⇧", "⇫", 1.2, Mod, Shift, .scheme = 1},
  {"z", "Z", 1.0, Code, KEY_Z, &layouts[ComposeZ]},
  {"x", "X", 1.0, Code, KEY_X, &layouts[ComposeX]},
  {"c", "C", 1.0, Code, KEY_C, &layouts[ComposeC]},
  {"v", "V", 1.0, Code, KEY_V, &layouts[ComposeV]},
  ...
  {"/", "?", 0.46, Code, KEY_SLASH},
  {"↑", "↑", 0.627, Code, KEY_UP, .scheme = 3},
  {"⇧", "⇫", 1.2, Mod, Shift, .scheme = 1},
  {"", "", 0.05, Pad},
  {"", "", 0.0, EndRow},

  {"", "", 0.05, Pad},
  {"󱌮", "󱌮", 0.4, Compose, .scheme = 4},
  {"󰘴", "󰘴", 0.5, Mod, Ctrl, .scheme = 1},
  {"", "", 0.5, Mod, Super, .scheme = 5},
  {"󰘵", "󰘵", 0.5, Mod, Alt, .scheme = 1},
  {"", "Tab", 4.85, Code, KEY_SPACE},
  {"←", "←", 0.462, Code, KEY_LEFT, .scheme = 3},
  {"↓", "↓", 0.462, Code, KEY_DOWN, .scheme = 3},
  {"→", "→", 0.462, Code, KEY_RIGHT, .scheme = 3},
  {"", "", 0.031, Pad},
  {"", "", 0.4, Layout, 0, &layouts[Special], .scheme = 4},
  {"", "", 0.05, Pad},
  /* end of layout */
  {"", "", 0.0, Last},
};
