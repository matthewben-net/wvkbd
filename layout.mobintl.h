...
static struct key keys_landscape[] = {
  ...
  {"󰌑", "󰌑", 1.15, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.05, Pad},
  {"", "", 0.0, EndRow},
  ...
  {"/", "?", 0.46, Code, KEY_SLASH},
  {"↑", "↑", 0.627, Code, KEY_UP, .scheme = 1},
  {"⇧", "⇫", 1.2, Mod, Shift, .scheme = 1},
  {"", "", 0.05, Pad},
  {"", "", 0.0, EndRow},

  {"", "", 0.05, Pad},
  {"󱌮", "󱌮", 0.4, Compose, .scheme = 1},
  {"󰘴", "󰘴", 0.5, Mod, Ctrl, .scheme = 1},
  {"", "", 0.5, Mod, Super, .scheme = 1},
  ...
  {"", "", 0.031, Pad},
  {"", "", 0.4, Layout, 0, &layouts[Special], .scheme = 1},
  {"", "", 0.05, Pad},
  /* end of layout */
  {"", "", 0.0, Last},
};
